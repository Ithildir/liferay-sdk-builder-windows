//------------------------------------------------------------------------------
// <copyright file="BackgroundTaskService.cs">
...
namespace Liferay.SDK.Service.V62.BackgroundTask
{
	public class BackgroundTaskService : ServiceBase
	{
		...
		public async Task<string> GetBackgroundTaskStatusJsonAsync(long backgroundTaskId)
		{
			...
			{
				{ "/backgroundtask/get-background-task-status-json", _parameters }
			};
		...
		public async Task<long> GetBackgroundTasksCountAsync(long groupId, string taskExecutorClassName, string completed)
		{
			var _parameters = new JsonObject();
			...
			var _command = new JsonObject()
			{
				{ "/backgroundtask/get-background-tasks-count", _parameters }
			};
